...
public class ControlMotorsDirectionAndSpeed {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SoftPwm.softPwmCreate(MOTOR_1_PIN_A, -100, 100);
        SoftPwm.softPwmCreate(MOTOR_2_PIN_A, -100, 100);
        // init GPIO pins
        final GpioPinDigitalOutput motor1pinE = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_23, "m1E");
        final GpioPinDigitalOutput motor2pinE = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_24, "m2E");
